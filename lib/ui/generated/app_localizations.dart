...
abstract class AppLocalizations {
  ...
  /// No description provided for @empty_tasks.
  ///
  /// In en, this message translates to:
  /// **'No tasks available'**
  String get empty_tasks;

  /// No description provided for @empty_checklists.
  ///
  /// In en, this message translates to:
  ...
  String get task_name_required;

  /// No description provided for @checklist_name_required.
  ///
  /// In en, this message translates to:
  ...
  /// In en, this message translates to:
  /// **'Task was added.'**
  String get task_added;

  /// No description provided for @checklist_added.
  ///
  /// In en, this message translates to:
  /// **'Checklist was added.'**
  String get checklist_added;

  /// No description provided for @remove_task_dialog_title.
  ///
  /// In en, this message translates to:
  /// **'Remove task'**
  String get remove_task_dialog_title;

  /// No description provided for @remove_task_dialog_desc.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @checklist_name.
  ///
  /// In en, this message translates to:
  /// **'Checklist name'**
